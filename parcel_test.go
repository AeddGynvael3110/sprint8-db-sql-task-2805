...
func TestGetByClient(t *testing.T) {
	...
	for _, parcel := range storedParcels {
		...
		expected, exists := parcelMap[parcel.Number] // убедитесь, что все посылки из storedParcels есть в parcelMap
		require.True(t, exists)                      // убедитесь, что значения полей полученных посылок заполнены верно
