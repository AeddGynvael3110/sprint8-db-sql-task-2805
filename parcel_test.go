...
func TestSetStatus(t *testing.T) {
	...
	newAddstatus := ParcelStatusSent

	err = store.SetStatus(id, newAddstatus)
	require.NoError(t, err)
...
func TestGetByClient(t *testing.T) {
	...
	for _, parcel := range storedParcels {
		...
		require.Equal(t, stored.Client, parcel.Client, "Не совпадает Client")
		require.Equal(t, stored.Status, parcel.Status, "Не совпадает Status")
		require.Equal(t, stored.Address, parcel.Address, "Не совпадает Address")
		require.Equal(t, stored.CreatedAt, parcel.CreatedAt, "Не совпадает CreatedAt")
		require.Equal(t, stored.Number, parcel.Number, "Не совпадает Number")
